    ...
    <BrandShell activePage="discover" onNavigate={onNavigate} primaryLabel="Your Library" onPrimaryAction={() => onNavigate("your-models")}>
      <main className="mx-auto max-w-6xl px-6 py-20">
        <section className="smooth-fade-in mb-16">
          {/* Modification du titre ici : "Discover" en blanc, "Models." en gris */}
          <h1 className="text-6xl font-medium tracking-tighter mb-6">
            Discover <span className="text-[var(--muted-ink)]">Models.</span>
          </h1>
            ...
            <article key={entry.id} className="group flex flex-col rounded-2xl border border-[var(--brand-line)] bg-white/[0.01] p-8 transition-all hover:bg-white/[0.03] hover:border-[var(--muted-ink)]">
              ...
              <div className="mt-auto space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-full bg-white py-3 text-xs font-bold uppercase tracking-widest text-black transition-transform active:scale-95 disabled:opacity-20 hover:scale-105"
                >
