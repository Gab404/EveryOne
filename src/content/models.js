export const SLM_DOWNLOADS = [
  {
    ...
    bestFor: "Choose it if you want a stable model for most PDFs with minimal setup effort.",
    strengths: ["Very versatile", "Fast locally", "Great baseline model"],
    downloadUrl:
      "https://huggingface.co/bartowski/Llama-3.2-1B-Instruct-GGUF",
    command:
      "huggingface-cli download bartowski/Llama-3.2-1B-Instruct-GGUF --include \"*Q4_K_M.gguf\" --local-dir ./models/llama-3.2-1b",
    mandatory: true,
  },
  {
    id: "phi-3.5-mini",
    ...
    bestFor: "Choose it for short, clear, and immediate answers on simple documents.",
    strengths: ["Low latency", "Structured output", "Low resource usage"],
    downloadUrl:
  ...
  },
  {
    ...
    bestFor: "Choose it if your documents are multilingual or your team works across languages.",
    strengths: ["Strong French support", "Solid multilingual quality", "Good size/reasoning balance"],
    downloadUrl:
  ...
  },
  {
    ...
    bestFor: "Choose it for long technical PDFs and complex questions needing broader context.",
    strengths: ["Advanced understanding", "Better on complex cases", "Richer context handling"],
    downloadUrl:
  ...
  },
  {
    ...
    bestFor: "Choose it for very fast daily usage on lightweight machines.",
    strengths: ["Very fast", "Ultra light", "Ideal for repetitive tasks"],
    downloadUrl:
